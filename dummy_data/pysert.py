...
class Date(AbstractDataSet):
    ...
    def next_value(self):
        ...
        if self.max_year < self.min_year:
            return datetime.date.today().isoformat()
        dt = datetime.date(random.randint(self.min_year, self.max_year), random.randint(1,12), random.randint(1,28))
        return dt.isoformat()


#------------------------------------------------------------------------------
class Address(AbstractDataSet):
    '''
     ds_dict will contain the following:
        {
            "name" : <string value>
    ...
    line = ["Mona Road", "Hope Road", "Old Hope Road", "Ligunae", "Spanish Town Road"]
    town = ["Kingston", "Spanish Town", "Montego Bay", "Portmore"]
    ...
    def next_value(self):
        ...
        return add
#------------------------------------------------------------------------------
class LaptopVendor(AbstractDataSet):
    '''
     ds_dict will contain the following:
        {
            "name" : <string value>
    ...
    '''
    vendors = ['Acer', 'HP', 'Dell', 'Apple', 'ASUS', 'Alienware', 'Sony', 'Lenovo', 'IBM']
    def validation_list(self):
        return ['name']
